...
CONFIG.EMPTY_PASSWORD ="Password field should not be empty"
CONFIG.EMPTY_NEW_PASSWORD ="New password field should not be empty"
CONFIG.INVALID_CONFIRM_PASSWORD = "Please enter valid confirm password";
CONFIG.EMPTY_CONFIRM_PASSWORD ="New password field should not be empty"
